...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='products/', default='default_images/no-image-available.png')
...
class PlantPrice(models.Model):
    ...
    def __str__(self):
        return f"{self.product.easy_name} - {self.get_size_display()} - {self.price}"